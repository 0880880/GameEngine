...
public class Physics {
    ...
    private static final HashMap<Integer, Collider> colliders = new HashMap<>();
    ...
    private static final com.badlogic.gdx.math.Vector2 tmpVec = new com.badlogic.gdx.math.Vector2();
